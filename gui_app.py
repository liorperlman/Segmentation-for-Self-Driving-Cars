...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.video_frame_a_l.grid(row=0, column=0, sticky="nsew")
        ...
        self.video_frame_a_m.grid(row=0, column=2, sticky="nsew")
        ...
        self.camera_button_frame.grid_columnconfigure(3, weight=1)
            # Camera
        ...
        self.start_camera_button = ttk.Button(self.camera_button_frame, text="Start", command=self.start_camera)
        self.start_camera_button.grid(row = 0, column = 0)
        self.stop_camera_button = ttk.Button(self.camera_button_frame, text="Stop", command=self.stop_camera)
        self.stop_camera_button.grid(row = 0, column = 1)
        self.start_recording_button = ttk.Button(self.camera_button_frame, text="Record", command=self.start_camera_recording)
        self.start_recording_button.grid(row = 0, column = 2)
